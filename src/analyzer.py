...
def analyze_market_summary(prices_text, headlines_text, ta_data="None"):
    ...
    try:
        ...
        📍 ចូលផ្សារ (Entry): [If Buy: BUY at $X. If Sell: SELL at $X. If Wait: រង់ចាំសិន (WAIT)]
        ...
        2. SUPPORT/RESISTANCE: Entry prices should ideally be near Pivot Points, S1, R1, or Bollinger Bands.
